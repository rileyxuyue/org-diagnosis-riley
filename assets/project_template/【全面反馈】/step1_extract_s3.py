...
# -*- coding: utf-8 -*-
"""
Step1: 从 S3 全面反馈开放题 Excel 抽取每位管理者的结构化原文清单
输出: output/s3/step1_output.xlsx（4个Sheet）
"""
import os
import re
import sys
...
INPUT_FILE = os.path.join(SCRIPT_DIR, '全面反馈开放题S3.xlsx')
OUTPUT_DIR = os.path.join(SCRIPT_DIR, 'output', 's3')
